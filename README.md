# sound-classification-Combined-Features
![](image.jpg)
...
2. The Mel Frequency Cepstral Coefficients(MFCC) and Mel Spectrogram are extracted from the time domain then the extracted features are combined together.
